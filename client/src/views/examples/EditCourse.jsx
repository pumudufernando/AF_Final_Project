...
class EditCourse extends React.Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/courses/update/'+this.props.match.params.id, obj)
            .then(res => console.log(res.data));

            axios.post('http://localhost:5000/assignment/updateAllCourses/'+this.state.oldCourseName+'/'+this.state.coursename)
            .then(res => console.log(res.data));

            axios.post('http://localhost:5000/api/updateAllCourses/'+this.state.oldCourseName+'/'+this.state.coursename)
            .then(res => console.log(res.data));

    }

    componentDidMount() {
        axios.get('http://localhost:5000/courses/edit/'+this.props.match.params.id)
            .then(response => {
                this.setState({
