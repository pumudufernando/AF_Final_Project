...
class UploadFile extends React.Component {
  ...
  uploadFile(e) {
    ...
    axios.get('http://localhost:5000/api/checkview/' + this.props.match.params.aName + '/' + this.state.student).then(
      res => {
        console.log(res)
        this.setState({
          info: res.data
          ...
          if ((this.state.file.size / 1024) < 10240) {
            ...
            fetch('/api/files', {
              ...
              .then(data => {
                ...
                if (data.success) {
                  axios.get("http://localhost:5000/api/getlast").then(res1 => {
                    ...
                    axios.post('http://localhost:5000/api/add', obj).then(
                      res => {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/assignment/getAssignmentBycName_aName/' + this.props.match.params.cName + '/' + this.props.match.params.aName).then(res => {
      console.log(res.data);
      this.setState({
