...
class AddAssignment extends React.Component {
  ...
  onDelete(e) {
    ...
    axios.get('http://localhost:5000/assignment/deleteAssignment/' + e.target.id)
  ...
  onEdit(e) {
    ...
    axios.get('http://localhost:5000/assignment/getAssignmentById/' + e.target.id).then(
      assignment => {
        this.setState({
  ...
  onUpdate(e) {
    ...
    if (cdate > ldd) {
      ...
      axios.post('http://localhost:5000/assignment/getAssignment/' + this.state.updateId, obj1).then(res => {
        console.log(res)
      }).catch(err => {
        console.log(err)
      })

      axios.post('http://localhost:5000/api/updateAllAssignments/' + this.state.oldAssignmentName + '/' + this.state.assignmentName)
  ...
  onSubmit(e) {
    ...
    if (cdate > ldd) {
      ...
      axios.post('http://localhost:5000/assignment/addAssignment', obj).then(res => console.log(res.data));
  ...
  onChangeAssignmentList(e) {
    ...
    axios.get('http://localhost:5000/assignment/getAssignmentByName/' + this.state.selectedCourse1).then(
  ...
  componentDidMount() {
    ...
    axios.get('http://localhost:5000/courses/getCourses/' + this.state.lecturer).then(
      courses => {
        this.setState({
