...
class ApprovalList extends React.Component {
    ...
    load(){
        axios.get('http://localhost:5000/approves/' + this.state.name)
        .then(response => {
    ...
    delete(e) {
        ...
        alert(e.target.id)
        axios.get('http://localhost:5000/approves/delete/' + e.target.id)
    ...
    sendx(e) {
        ...
        axios.get('http://localhost:5000/approves/get/' + e.target.id).then(res => {
            ...
            axios.post('http://localhost:5000/courses/add/', obj)
            .then(res => console.log(res.data));

            axios.get('http://localhost:5000/approves/delete/'+x)
            .then(console.log('Deleted'))
            .catch(err => console.log(err))
