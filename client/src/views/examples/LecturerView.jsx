...
class LecturerView extends React.Component {
    ...
    loadFiles() {
        ...
        axios.get('http://localhost:5000/courses/getCourses/' + this.state.lecturer)
            .then(response => {
    ...
    handleFilter(e) {
        this.setState({
            ...
            axios.get("http://localhost:5000/assignment/getAssignmentByaName/" + this.state.filterValue).then(res => {
    ...
    filterclick(e) {
        ...
        axios.get('http://localhost:5000/api/lecassview/' + this.state.filterValue1 + '/' + this.state.filterValue).then(res => {
